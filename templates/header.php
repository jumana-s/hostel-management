<div class="container">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4">
        ...
        <!-- <div class="dropdown my-auto ms-4">
            <button class="btn btn-lg dropdown-toggle text-light dark-blue-bg" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                Login
            </button>
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="login.php">Student</a></li>
                <li><a class="dropdown-item" href="login_advisor.php">Advisor</a></li>
