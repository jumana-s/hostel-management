            ...
            <div class="row align-items-md-stretch">
                ...
                <div class="col-md-7 p-5 mb-4 bg-light rounded-3">
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <?php
                                 $result = $connection->query("SELECT sa.advisor_fname, sa.advisor_lname, sa.job_pos, sa.dept_name, sa.internal_ph, sa.room_INT FROM Staff_Advisor sa, Student s WHERE s.student_id=".$_SESSION['student']." AND s.advisor_id = sa.advisor_id");
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<td class="fs-4">'.$row["room_INT"].'</td>';
                                    echo '</tr>';
